---
layout: docs title: Navs and tabs description: Documentation and examples for how to use Bootstrap's included navigation
components. group: components aliases: "/docs/5.1/components/navs/"
toc: true
---
...
current page, or `true` for the current item in a set. {{< /callout >}}
