    ...
    <script type="text/javascript">
        $(function () {//给label标签绑定单机事件
            $("#inputPageNoLabel").click(function () {
                ...
                //边界检查
                if (pageNo <= 1)
                    location.href = "${pageScope.basePath}book/bookServlet?action=searchPages&pageNo=1";
                else if (pageNo >= pageCount)
                    location.href = "${pageScope.basePath}book/bookServlet?action=searchPages&pageNo=" + pageCount;
                else
                    location.href = "${pageScope.basePath}book/bookServlet?action=searchPages&pageNo=" + pageNo;//在EL表达式中其获取域对象变为了pageScope->pageContext requestScope->Request sessionScope->Session applicationScope->ServletContext
            })
...
<div class="toptip">
    ...
    <div class="toptip_search">
        <form action="book/bookServlet" method="get">
            <input name="action" type="hidden" value="searchPages" style="display:none;">
            <table align="center">
                <tr>
